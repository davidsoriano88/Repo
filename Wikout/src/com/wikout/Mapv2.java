...
public class Mapv2 extends ActionBarActivity {
	...
	Location location;
	double longitudeSW, latitudeSW, longitudeNE, latitudeNE, selectedLat,
			selectedLon;
	...
	public void initUI() {
		...
		map.setOnMapClickListener(new OnMapClickListener() {
			...
			public void onMapClick(LatLng point) {
				...
				/*
				 * Intent mapLocation=new Intent(); // put the message in Intent
	 ...
	 * (item.getItemId()) { case R.id.refresh: new LoadDataTask().execute();
	 * return true; case android.R.id.home: finish(); return true; default:
	 * return super.onOptionsItemSelected(item); } }
	 */
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.findItem(R.id.btnOkMap).setEnabled(enableOk).setVisible(enableOk);
	 ...
	 * getMenuInflater(); inflater.inflate(R.menu.menu2, menu);
	 * 
	 * return super.onCreateOptionsMenu(menu); }
	 */
	@Override
